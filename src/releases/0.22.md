...
SendChain constantly working on improving decentralized token swapping capabilities to enable token swapping at optimal rates. This version features:
...
The latest update brings a new version of the FAQ page. This page was redone addressing the most common questions and usage issues that users have experienced with SendChain over the past.

https://sendchain.money/faq
...
Zcash users now have the ability to send transactions to transparent addresses. Previously, SendChain supported only shielded addresses.
