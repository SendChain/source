# What should someone do before using SendChain?

Before doing anything on SendChain you're strongly encouraged to go over the Academy section and get familiar with essential aspects of cryptocurrency and DeFi ecosystem.
...
Apart from Academy, users are recommended to go over SendChain terms (Settings > About section) and make sure they understand what SendChain wallet is and risks involved in using the app.
