# Which DEXes supported in SendChain?

SendChain wallet currently supports following decentralized exchanges:
...
In the near future, SendChain aims to complete integration with Thorchain (https://thorchain.org) decentralized exchange that enables cryptocurrency trades between blockchains for the first time.
