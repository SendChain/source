# What to do before using SendChain

Before doing anything on SendChain, users are encouraged to go over the Academy section and get familiar with essential aspects of cryptocurrency and the DeFi ecosystem.
...
Users are also advised to go over the App Terms (**Settings > About**) and make sure they understand what SendChain wallet is and the risks involved while using the app.
