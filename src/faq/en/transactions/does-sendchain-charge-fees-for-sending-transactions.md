# Does SendChain charge fees for sending transactions?
...
These transaction fees do not pass through SendChain but paid by the user directly to the network when executing transactions.