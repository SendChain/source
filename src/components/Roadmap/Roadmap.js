    ...
    <div className="card card-rounded border-0 bg-steel-10 p-4">
      ...
      <div className="card-footer pt-3">
        <div className="border-top mt-2 pt-2">
          <a href={`https://github.com/sendchain/sendchain-wallet-android/releases/tag/${version}.0`}
             target="_blank"
             rel="noopener noreferrer"
             className="text-warning small">Android</a>
          &nbsp;&nbsp;
          <a href={`https://github.com/sendchain/sendchain-wallet-ios/releases/tag/${version}`}
             target="_blank"
             rel="noopener noreferrer"
