...
class Header extends React.Component {
  ...
  render() {
    ...
    const navigation = (
      <div className="nav">
        <a target="_blank" rel="noopener noreferrer" className="nav-item" href="https://sendchain.io/">
          About Us
        </a>
        ...
        <Container>
          <div className="navbar">
            <Link to="/" onClick={this.onClickHome}>
              <img className="Header-logo" src={HeaderLogo} alt="SendChain Cryptocurrency Wallet" />
            </Link>
