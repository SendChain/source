        ...
        <div className="Page-content">
          <div className="Page-end">
            ...
            <div className="Section-info Join-section-info">
              Stay on top of SendChain happenings. Be the first to know about new features, user reported issues and things we work on!            </div>
          </div>
          <div className="Page-start">
            <div className="Join-icons">
              <div className="Join-icon">
                <a href="https://twitter.com/sendchainbyhs" target="_blank" rel="noopener noreferrer">
                  <img className="Join-image" src={twitter} alt="Twitter" />
                </a>
              </div>
              <div className="Join-icon">
                <a href="https://github.com/sendchain/" target="_blank" rel="noopener noreferrer">
                  <img className="Join-image" src={github} alt="github" />
                </a>
              </div>
              <div className="Join-icon">
                <a href="https://t.me/sendchain_announcements" target="_blank" rel="noopener noreferrer">
            ...
            <div className="Join-icons">
              ...
              <div className="Join-icon">
                <a href="https://sendchainwallet.medium.com/" target="_blank" rel="noopener noreferrer">
