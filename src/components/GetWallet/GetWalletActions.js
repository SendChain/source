    ...
    <div className="Wallet-actions">
      <div className="Banner-actions">
        ...
        <Button
          ...
          text="Google Play"
          icon="google-play"
          link="https://play.google.com/store/apps/details?id=io.sendchain.bankwallet" yellow newTab />
        <Button
          className="Button-circle"
          text="App Store"
          icon="app-store"
      ...
      <div className="Banner-links">
        <Button
          ...
          text="F-Droid"
          icon="f-droid"
          link="https://f-droid.org/en/packages/io.sendchain.bankwallet/" newTab />
        <Button
          className="Button-circle Button-download"
          text="APK file"
          icon="download"
          link="https://github.com/sendchain/sendchain-wallet-android/releases" newTab />
        <Button
          className="Button-circle Button-download"
          text="Github"
          icon="github"
          link="https://github.com/sendchain" newTab />
        <Button
          className="Button-circle Button-download"
          text="Gitlab"
          icon="gitlab"
